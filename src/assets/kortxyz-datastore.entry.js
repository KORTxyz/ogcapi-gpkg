...
import { c as createNewStore } from './store-C9Stgfg-.js';
import { g as getDefaultExportFromCjs, c as commonjsGlobal } from './_commonjsHelpers-Cf5sKic0.js';
...
var jsonata$2 = {exports: {}};

var jsonata$1 = jsonata$2.exports;

var hasRequiredJsonata;

function requireJsonata () {
	if (hasRequiredJsonata) return jsonata$2.exports;
	hasRequiredJsonata = 1;
	(function (module, exports) {
		(function(f){if('object'==="object"&&'object'!=="undefined"){module.exports=f();}else if(typeof undefined==="function"&&undefined.amd){undefined([],f);}else {var g;if(typeof window!=="undefined"){g=window;}else if(typeof commonjsGlobal!=="undefined"){g=commonjsGlobal;}else if(typeof self!=="undefined"){g=self;}else {g=this;}g.jsonata = f();}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof commonjsRequire&&commonjsRequire;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t);}return n[i].exports}for(var u="function"==typeof commonjsRequire&&commonjsRequire,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
		/**
...
const KortxyzDatastore = class {
    ...
    async componentWillLoad() {
        ...
        if (isNaN(geojson.features[0]?.id))
            geojson.features.forEach((feat, idx) => (feat.id = idx + 1));
        store.set("data", geojson);
        store.set("filtereddata", geojson);
        store.onChange("editeddata", async (newData) => {
            if (this.sync) {
                const oldData = store.get("data");
                const diff = distExports.getDiff(oldData, newData);
                for (const adds of diff.added)
                    this.handleAdds(store, newData, adds);
                for (const edits of diff.edited)
                    this.handleEdits(store, newData, edits);
            }
            else {
                store.set("data", newData);
                store.set("filtereddata", newData);
...
KortxyzDatastore.style = kortxyzDatastoreCss;

export { KortxyzDatastore as kortxyz_datastore };
//# sourceMappingURL=kortxyz-datastore.entry.esm.js.map
